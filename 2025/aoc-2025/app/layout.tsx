...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      >
        <nav className="p-6 w-64 flex-shrink-0 border-r border-gray-800 bg-gray-900 flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-2">
            <Link
                href="/"
                className="block px-4 py-2 rounded-md hover:bg-gray-800 text-sm transition-colors text-gray-300 hover:text-white"
            >
                Home
            </Link>
